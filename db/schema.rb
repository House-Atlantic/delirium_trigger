...
ActiveRecord::Schema[7.0].define(version: 2022_09_09_191643) do
  ...
  create_table "roles", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["company_employee_id"], name: "index_roles_on_company_employee_id"
  end

  add_foreign_key "company_employees", "companies"
  add_foreign_key "company_employees", "employees"
  add_foreign_key "roles", "company_employees"
end
